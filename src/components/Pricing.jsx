      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl shadow overflow-hidden p-10 border border-primary/70">
            ...
            <button className="w-full px-6 py-2.5 bg-gray-50 rounded text-center cursor-pointer">
              Get Started
            </button>
          ...
          <div className="relative bg-white rounded-2xl shadow overflow-hidden p-10 border border-primary/70">
            ...
            <button className="w-full px-6 py-2.5 bg-gray-50 rounded text-center cursor-pointer bg-primary text-white font-semibold">
              Get Started
            </button>
