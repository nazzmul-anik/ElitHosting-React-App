...
import { assets, domainData, teamData } from "../assets/assets";
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-dark/80">
            Learn about our story and mission to provide the best hosting
            experience
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mb-8">
          <div className="w-full md:w-1/2">
            ...
            <p className="text-xl text-dark/80 mb-6">
              Founded in 2010, Elithost started with a simple mission: to make
              web hosting accessible, reliable, and affordable for everyone.
            </p>
            <p className="text-xl text-dark/80 mb-6">
              What began as a small startup with a single server has grown into
              a global hosting provider with data centers around the world and
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          {teamData.map((team, index) => (
            <div
              key={index}
              className="w-70 shadow rounded-2xl overflow-hidden"
            >
              <img
              ...
              <div className="text-center p-8">
                ...
                <p className="text-xl text-dark/60 font-bold">
                  {team.designation}
                </p>
              </div>
            </div>
