      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center mb-16">
          <div className="w-full md:w-1/2 p-8">
            ...
            <p className="text-xl text-dark/80 mb-6">
              Perfect for beginners and small websites. Get started with our
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-2">
                <FaCheckCircle className="text-primary" />
                <span>EFree website migration</span>
              </li>
            </ul>
            <a
              href="#"
              className="text-dark font-bold flex items-center gap-2 mt-6"
            >
              View Details
              <FaArrowRightLong />
            </a>
        ...
        <div className="flex flex-col md:flex-row items-center mb-16">
          ...
          <div className="w-full md:w-1/2 p-8 ml-8">
            <FaCloud className="text-4xl text-primary mb-8" />
            <h1 className="text-3xl text-dark font-bold mb-8">VPS Hosting</h1>
            <p className="text-xl text-dark/80 mb-8">
              Get more power and flexibility with our Virtual Private Server
              solutions.
            </p>
            <ul className="space-y-4">
              <li className="flex items-center gap-2">
            ...
            <a
              href="#"
              className="mt-8 flex items-center gap-2 text-dark font-bold"
            >
              View Details
              <FaArrowRightLong />
            </a>
        ...
        <div className="flex flex-col md:flex-row items-center mb-16">
          <div className="w-full md:w-1/2 p-8">
            ...
            <p className="text-xl text-dark/80 mb-6">
              Maximum performance and security with your own dedicated server.
            </p>
            <ul className="space-y-4">
              <li className="flex items-center gap-2">
                <FaCheckCircle className="text-primary" />
